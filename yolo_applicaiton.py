...
# Load YOLO model
try:
    model_path = r'C:\Users\kaush\Desktop\License_plate\License_plate\best.pt'  # Update to your model path
    model = YOLO(model_path)  # Replace with the path to your trained YOLO model
